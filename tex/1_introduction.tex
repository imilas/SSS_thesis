...
\section{Thesis Statement and Contributions}
  The central thesis of this work is that new drum sounds can be created and organized into drum kits for music producers virtually, by random and rapid programming of virtual synthesizers and use of virtual listeners for distinguishing synthesizer sounds resembling drums from non-drums. We seek to implement a system of virtual sound generation where 50\% or more of the sounds generated resemble drum sounds, verified with manual listening.\\
