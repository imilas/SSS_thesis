...
\includegraphics[width=13cm,height=8cm]{images/chapter3/Optimization_History.pdf}
...
We recursively run the autoencoder on new sounds and display the results in figures ~\ref{fig:recreation1} and ~\ref{fig:recreation2}. Spectrograms belonging to percussive groups or are recreated accurately, while details in synthetic noise spectrograms are quickly dissipated, unless the noise has percussive characteristics. We hypothesize that this "confusion" by the encoder leads to embedding of familiar sounds being distinguishable from those unseen. If correct, this approach may have beneficial implications in addressing the aforementioned OSR problem.
