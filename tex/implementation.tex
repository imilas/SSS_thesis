...
\begin{center}
    ...
    \makebox[\textwidth]{
    \subfloat[Precision, recall, F1-Score, and number of supporting examples]{ \includegraphics[width=9cm,height=9cm]{images/chapter3/f1_mme.pdf}
    \includegraphics[width=9cm,height=9cm]{images/chapter3/f1_dvn.pdf}
    }
...
\begin{center}
    \makebox[\textwidth]{
    \subfloat[Confusion matrices for both tasks]{ \includegraphics[width=9cm,height=9cm]{images/chapter3/conf_mme.pdf}
    \includegraphics[width=9cm,height=9cm]{images/chapter3/conf_dvn.pdf}
    }}
\end{center}
