...
\section{How The Datasets Will Be Used}
 We utilize these databases depending on the task at hand. At times, we merged or purged drum groups to simplify tasks. As stated earlier, in Section~\ref{sec:ear}, we discuss how supervised machine learning algorithms trained learn to categorize drums from non-drums using the datasets discussed here as examples. 
