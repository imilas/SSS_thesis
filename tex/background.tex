...
This chapter aims to provide a background for the subsequent chapters via a quick overview of three important topics: A brief cover of the digital audio and concepts that have been fundamental to our work, a quick overview of digital synthesis techniques, and finally, related works and their relative similarities and distinctions.
...
\\\\
\subsection{Loudness and Envelopes}
...
\section{Digital Audio Generation}
\subsection{Filters, Oscilators...}
\subsection{?}
