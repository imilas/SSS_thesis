...
We categorized reviewed works into three general groups. Those which have used DSP for both feature extraction and synthesis, those which used ANNs for both, those which have used a mix (mostly ANN for feature learning and DSP for synthesis). 

\begin{center}

\begin{table}
 \resizebox{\linewidth}{!}{\begin{tabular}{||c c c c||} 
work & feature extraction & synthesis & goal \hline
\end{tabular}}
\caption{Taxonomy}
\end{table}
\end{center}
