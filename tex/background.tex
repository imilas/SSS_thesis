...
In 1963, Mathews \cite{mathews1963digital} wrote on the utility of computers as digital instruments: By presenting a snapshot of digital audio technology of his time and making predictions on what will be possible in the near future. Much of the underlying approaches described have remained relatively unchanged, yet subject to up-scaling alongside Moore's law \cite{mack2011fifty,smith1991viewpoints}. For instance, Mathews described a general method for computers to capture and internally represent sound: By discretely sampling pressure waves. 
...
% Based on this general method, suppose one day we came across a pure, 1000 Hz tone one day and we wished to record it and play it back in our living room. What are the needed tools and limitations?
