...
Neural nets can be used to create sounds 1 sample at a time ~\cite{oord2016wavenet}. This process is slow, as Mathews predicted. Even the faster versions are pretty slow. Neural nets are function approximators that learn via trial and error. What are they trying to approximate, when they learn from digitized sound? Where is the line where they become more efficient than DSP methods? 
