...
We present a number of the approaches we have taken towards the automatic generation of synthesizer programs which mimic one-shot percussive sounds. 
We focus on the implementation an automatic system for generation of quick and scalable percussion synthesizers using classical signal processing. Our system relies on virtual ears to automatically find synthesizer programs that mimic percussive sounds, and further categorize these programs into a number of common drum types.
...
To facilitate future research, we share our curated datasets of free percussive sounds. These datasets can be used for the replication of our work, or to facilitate new research. 
\end{abstract}
