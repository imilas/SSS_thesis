...
\begin{figure}[t!]
    ...
    \textbf{TPE Design}
    \makebox[\textwidth]{
    \fbox{\includegraphics[width=1.1\linewidth]{images/chapter_3/TPE_ear.pdf}}}
    \end{center}
...
\textbf{CNN-DVD}: A CNN model trained on Spectrum features. Reaching 82\% accuracy in a 6-way drum categorization in Phase 2. A combination of a CNN model with output channel size of 4, kernel of size of 5, another CNN model with output channel size of 8 and kernel of size 3. Followed by a fully connected network of shape 100x20x6.\\
\begin{center}
\vbox{
    \begin{lstlisting}[caption=Sequential Layers for CNNLSTM-dvn]
            Layer                       Details
...
\begin{figure}[t!]
    ...
    \textbf{MEM Design}
    \makebox[\textwidth]{
    \fbox{\includegraphics[width=1.1\linewidth]{images/chapter_3/MEM_ear.pdf}}}
    \end{center}
