...
\begin{lstlisting}[caption=CNNLSTM-dvn]
                    Layer                 Output Shape
                =======================================
                    Conv2d-1             [@($\mathcal{B}$)@, 2, 20, 20]
                      ReLU-2             [@($\mathcal{B}$)@, 2, 20, 20]
                   Dropout-3             [@($\mathcal{B}$)@, 800]
                  LSTMCell-4             [[@($\mathcal{B}$)@, 20], [@($\mathcal{B}$)@, 20]]
                    Linear-5             [@($\mathcal{B}$)@, 2]
                   Softmax-6             [@($\mathcal{B}$)@, 2]
                =======================================
\end{lstlisting}
