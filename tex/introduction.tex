...
Computers can be programmed to extract the majority of these feature types for us. Particularly with shorter audio clips (such as the drum sounds we're interested in) human subjectivity plays a smaller role in describing sounds and the categorization task becomes easier. 
