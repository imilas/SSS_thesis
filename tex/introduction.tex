...
%% TODO
% AH: citations are not nouns. Please use X et al.~\cite{...}
...
\end{figure*}
 ...
 % AH: what's the point? Why are we here? You want to synthesize drums?
 
 % AH: Why are talking about categorizing sounds now?
 
 % AH: Maybe motivate OK we can generate synthesizes but can we determine if they are any good?
