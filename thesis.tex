...
\usepackage[inline]{enumitem}                % Enhanced 'enumerate'
...
\definecolor{backcolour}{rgb}{0.98,0.98,1}
...
\subfile{\main/tex/0_abstract.tex}
\subfile{\main/tex/0_3_preface.tex}
\subfile{\main/tex/0_1_acknowledgements.tex}
\doublespacing
% \truedoublespacing
% \singlespacing
% \onehalfspacing
...
% \subfile{\main/tex/0.1_quote.tex}
% \subfile{\main/tex/0_1_acknowledgements.tex}
% \subfile{\main/tex/0_2_dedication.tex}
\subfile{\main/tex/1_introduction.tex}
\subfile{\main/tex/2_background.tex}
\subfile{\main/tex/3_planning.tex}
\subfile{\main/tex/4_synth}
\subfile{\main/tex/5_ear}
\subfile{\main/tex/6_novel_generations.tex}
\subfile{\main/tex/7_testing_the_system}
\subfile{\main/tex/8_conclusion.tex}
